...
### 3. RUN FPGROWTH ALGORITHM ON TRAINING SET ###

# Convert the training data to boolean
train_data = train_data.astype(bool)

# Define the FPGrowth algorithm parameters
supports = [0.1]
confidences = [0.3]
...
for minimum_support in supports:
    for minimum_confidence in confidences: 
        ...
        # Apply the FPGrowth algorithm to find frequent itemsets in the training DataFrame
